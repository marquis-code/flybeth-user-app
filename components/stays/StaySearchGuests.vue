<template>
  <div class="relative w-full lg:w-56" ref="pickerRef">
    ...
    <div 
      @click="isOpen = !isOpen"
      class="flex-1 min-w-[200px] bg-white rounded-r-[1.75rem] px-8 py-4 group hover:bg-white transition-all cursor-pointer"
    >
      <p class="text-sm text-black font-bold  mb-2 opacity-50 group-hover:opacity-100 transition-opacity">Travelers</p>
    ...
    <!-- Dropdown -->
    <div v-if="isOpen" class="absolute top-full right-0 mt-4 z-[200] bg-white rounded-[2rem] shadow-[0_30px_90px_-20px_rgba(0,0,0,0.15)] border border-gray-200 w-[92vw] sm:w-[320px] p-8">
        <!-- Mobile Close Button -->
        <button @click="isOpen = false" class="md:hidden absolute top-4 right-4 h-9 w-9 flex items-center justify-center text-black bg-white rounded-full hover:text-black transition-colors">
        ...
        <div class="space-y-8">
          ...
          <div class="flex items-center justify-between">
            <div>
              <div class="text-[11px]  text-black ">Rooms</div>
          ...
          <div class="flex items-center justify-between">
            <div>
              <div class="text-[11px]  text-black ">Adults</div>
          ...
          <div class="flex items-center justify-between">
            <div>
              <div class="text-[11px]  text-black ">Children</div>
          ...
          <button 
            @click="apply"
            class="w-full bg-black hover:bg-black text-white  py-4 rounded-2xl transition-all  text-sm active:scale-[0.98] mt-4"
          >
            Apply changes
          </button>
        </div>

        <p class="text-sm text-black font-bold leading-relaxed mt-8 opacity-60 ">
