<template>
  <div class="flex flex-col w-full font-body">
    ...
    <div class="relative group">
      <div 
        v-if="icon" 
        class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none text-gray-900 group-focus-within:text-gray-900 transition-colors duration-300"
      >
