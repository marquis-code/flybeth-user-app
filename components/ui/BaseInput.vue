  ...
  <div class="flex flex-col w-full font-body">
    ...
    <div class="relative group">
      ...
      <input
        ...
        :class="[
          'block w-full bg-white border border-gray-300 rounded-[1.5rem] shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] transition-all duration-500 font-bold text-brand-blue placeholder:text-gray-300 focus:outline-none focus:ring-4 focus:ring-brand-blue/5 focus:border-brand-blue focus:shadow-xl',
          icon ? 'pl-14' : 'px-6',
