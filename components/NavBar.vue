<template>
  <div class="navbar-wrapper">
    <nav 
      :class="[
        'fixed top-0 lg:top-4 left-1/2 -translate-x-1/2 z-[99999] transition-all duration-500 w-full lg:w-[calc(100%-48px)] max-w-7xl',
        isScrolled 
          ? 'bg-white border-b border-gray-100 py-3 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] lg:rounded-[24px]' 
          : 'bg-white border border-gray-100 py-4 lg:py-5 lg:rounded-[28px] shadow-sm'
      ]"
    >
        ...
        <div class="flex justify-between items-center">
          ...
          <div class="hidden lg:flex items-center bg-neutral-900/5 px-2 py-1.5 rounded-full border border-black/5">
            ...
            <div class="relative group">
              ...
              <div class="absolute left-0 top-[calc(100%+8px)] invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-2 group-hover:translate-y-0 z-[100000]">
                <div class="bg-white border border-gray-100 rounded-[28px] p-3 w-64 shadow-[0_24px_48px_-12px_rgba(0,0,0,0.15)]">
          ...
          <div class="hidden lg:flex items-center space-x-3">
            ...
            <div class="relative group">
              ...
              <div class="absolute right-0 top-[calc(100%+12px)] w-72 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0 z-[100000]">
                <div class="bg-white/95 backdrop-blur-2xl border border-gray-100 p-8 rounded-[32px] shadow-[0_24px_48px_-12px_rgba(0,0,0,0.1)]">
                  ...
                  <a href="tel:+18443592384" class="block w-full text-center bg-gradient-to-r from-primary to-primary-dark text-white py-4 rounded-2xl font-bold text-lg hover:shadow-xl hover:-translate-y-0.5 transition-all mb-4 shadow-lg shadow-primary/20">+1 844 FLYBETH (359-2384)</a>
                  
                  <div class="flex flex-col items-center gap-2 mt-2">
                    <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Email Assistance</p>
                    <a href="mailto:Hello@flybeth.com" class="text-sm font-bold text-primary hover:underline">Hello@flybeth.com</a>
                  </div>

                  <div class="text-center p-3 bg-secondary/5 rounded-xl mt-6">
