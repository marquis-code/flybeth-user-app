        ...
        <div class="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-md overflow-hidden animate-scale-up border border-gray-100">
          ...
          <div class="p-8 pt-6">
            ...
            <form v-if="step === 'login'" @submit.prevent="handleLogin" class="space-y-5">
              ...
              <button :disabled="loading" type="submit" class="w-full py-3 bg-gray-900 text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] hover:bg-black transition-all transform active:scale-[0.98] mt-4 shadow-xl shadow-gray-200 flex items-center justify-center gap-3">
                <span v-if="!loading">{{ isLogin ? 'Login' : 'Complete Registration' }}</span>
            ...
            <form v-else-if="step === 'register'" @submit.prevent="handleRegister" class="space-y-5">
              ...
              <button :disabled="loading" type="submit" class="w-full py-3 bg-gray-900 text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] hover:bg-black transition-all transform active:scale-[0.98] mt-4 shadow-xl shadow-gray-200">
                {{ loading ? 'Securing Account...' : 'Signup' }}
              </button>
            </form>
            ...
            <div v-else-if="step === 'otp'" class="space-y-8 py-2">
              ...
              <div class="space-y-4 pt-2">
                <button 
                  ...
                  class="w-full py-3 bg-[#FF4500] text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] hover:bg-orange-700 transition-all transform active:scale-[0.98] shadow-xl shadow-orange-100 disabled:opacity-50"
                >
            ...
            <div v-if="step !== 'otp'">
              <div class="relative py-8">
                ...
                <div class="relative flex justify-center text-[9px] uppercase tracking-[0.4em]"><span class="bg-white px-6 text-gray-500 font-black">or</span></div>
              </div>

              <button type="button" @click="loginWithGoogle" class="w-full flex items-center justify-center gap-4 px-5 py-4 border border-gray-100 rounded-2xl bg-white hover:bg-gray-50 transition-all text-sm tracking-[0.2em] text-gray-900 shadow-sm group">
