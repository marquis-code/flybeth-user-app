<template>
  <div class="trip-customization-step">
    ...
    <div class="fare-summary-card">
      <h3 class="summary-title text-brand-blue uppercase tracking-widest font-black italic">Fare Summary</h3>
      <div class="fare-routes space-y-4 pt-4">
        ...
        <div v-if="stay" class="fare-route">
          ...
          <div class="route-line">
            ...
            <span class="route-meta ml-3 font-black text-brand-blue">{{ stay.roomName || stay.selectedRoom?.name || 'Selected Room' }}</span>
          </div>
        </div>
      </div>

      <div v-if="traveller" class="traveller-summary pt-6 mt-6 border-t border-gray-100">
        <h4 class="traveller-label text-[9px] font-black text-gray-400 uppercase tracking-widest mb-3">Traveller Profile</h4>
        <div class="flex items-center justify-between">
           <div>
              <p class="traveller-info text-sm font-black text-gray-900">{{ traveller.firstName }} {{ traveller.lastName }}</p>
           ...
           <div class="bg-brand-blue/5 text-brand-blue text-[9px] font-black px-2 py-1 rounded uppercase tracking-widest">
    ...
    <div class="addons-list">
      <h3 class="text-[11px] font-black text-gray-900 uppercase tracking-widest mb-4 pl-1 italic">Trip Add-ons</h3>
      <div v-for="addon in addOnsList" :key="addon.id" class="addon-card hover:border-brand-blue/30 group transition-all">
        ...
        <div class="addon-info">
          ...
          <a href="#" class="addon-terms text-brand-blue">Terms & Conditions</a>
        </div>
    ...
    <div class="step-actions mt-10">
      <button @click="$emit('continue')" class="continue-btn bg-[#f27c22] hover:bg-orange-600 shadow-xl shadow-orange-100 px-12 py-5 rounded-2xl font-black uppercase tracking-widest text-white transition-all active:scale-[0.98]">
        Continue to Payment
