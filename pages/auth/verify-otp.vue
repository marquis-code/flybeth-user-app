<template>
  <div class="space-y-8">
    <div>
      ...
      <h3 class="text-4xl  text-gray-900 font-header tracking-tighter">Verify Email</h3>
    ...
    <form class="space-y-6" @submit.prevent="handleVerifyOtp">
      ...
      <p class="text-center text-sm text-brand-gray/60 font-bold mt-4">
        ...
        <button type="button" @click="handleResend" class="text-brand-green hover:underline ">Resend</button>
      </p>
    </form>
  </div>
</template>
