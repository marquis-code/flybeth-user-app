  ...
  <div class="min-h-screen bg-white/30">
    ...
    <div class="bg-brand-blue pt-20 pb-12 px-6 overflow-hidden relative">
      <div class="max-w-4xl mx-auto relative z-10">
        ...
        <h1 class="text-3xl md:text-4xl  text-white mb-6 ">Terms & conditions</h1>
        <p class="text-sm font-bold text-white/40  ">Last updated: April 2026</p>
      </div>
      <!-- Abstract Background -->
    ...
    <div class="max-w-4xl mx-auto px-6 py-20">
      <div class="bg-white rounded-[3rem] p-12 shadow-xl shadow-brand-blue/5 border border-gray-200">
        <div class="prose prose-slate max-w-none space-y-16">
          <section>
            ...
            <p class="text-black leading-relaxed pl-14">
          ...
          <section>
            <div class="flex items-center gap-4 mb-6">
              ...
              <h2 class="text-2xl  text-black">Booking policy</h2>
            </div>
            <p class="text-black leading-relaxed pl-14">
          ...
          <section>
            <div class="flex items-center gap-4 mb-6">
              ...
              <h2 class="text-2xl  text-black">Cancellation & refunds</h2>
            </div>
            <p class="text-black leading-relaxed pl-14">
          ...
          <section>
            <div class="flex items-center gap-4 mb-6">
              ...
              <h2 class="text-2xl  text-black">Liability</h2>
            </div>
            <p class="text-black leading-relaxed pl-14">
          ...
          <div class="pt-12 border-t border-gray-200 mt-12">
            <div class="bg-white rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                <p class="text-sm text-black font-bold mb-1">Have questions about our terms?</p>
                <p class="text-xs text-black">Our support team is here to help you 24/7.</p>
              </div>
              <a href="mailto:support@flybeth.com" class="px-8 py-3 bg-brand-blue text-white rounded-xl text-xs font-bold  hover:bg-brand-blue/90 transition-all shadow-lg shadow-brand-blue/20">
                Contact support
              </a>
            </div>
          </div>
